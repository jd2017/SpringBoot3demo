...
public class DemoTestUser extends BaseEntityNew {
    ...
    public String toString() {
        return "DemoTestUser{" +
                ...
                ", password='" + password + '\'' +
                ", email='" + email + '\'' +
                ", autoCreateCaseJobName='" + autoCreateCaseJobName + '\'' +
                ", startTestJobName='" + startTestJobName + '\'' +
                ", defaultJenkinsId=" + defaultJenkinsId +
